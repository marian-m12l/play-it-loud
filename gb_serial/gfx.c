            ...
            for (int y = 0; y < TILE_HEIGHT; ++y) {
                for (int x = 0; x < TILE_WIDTH; x += TILE_WIDTH) {
                    ...
                    for (int i = 0; i < TILE_WIDTH; ++i) {
                        ...
                        // Calculate luminance.
                        // TODO Adjust factors per channel ???
                        ...
                        //printf("tileY=%d tileX=%d y=%d x=%d i=%d --> index=%d rgb565=%02x r=%f g=%f b=%f lum=%f pal=%d\n", tileY, tileX, y, x, i, index, image_data_rgb565[index], r, g, b, lum, paletteIndex);
